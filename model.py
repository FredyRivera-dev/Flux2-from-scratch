...
## Okay, I'll try with a 2.4B model and try to train it on an NVIDIA H200 or similar.
...
class Flux2(nn.Module):
    def __init__(self, params: Flux2Params, init_weights: bool = False):
        super().__init__()
...
if __name__ == "__main__":
    # Test to validate that all parameters are trainable
    model = Flux2(Flux2Params(), init_weights=True)
    ...
    if frozen_params > 0:
        print(f"Warning: {frozen_params:,} frozen parameters")
    else:
